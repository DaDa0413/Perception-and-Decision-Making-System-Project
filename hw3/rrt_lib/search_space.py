...
from rrt_lib.geometry import es_points_along_line
from rrt_lib.obstacle_generation import obstacle_generator
...
class SearchSpace(object):
    ...
    def sample(self):
        ...
        """
        # print(self.dimension_lengths[:, 0])
        # print(self.dimension_lengths[:, 1])
        # print('-----------------')
