...
def navigateAndSee(action=""):
    if action in action_names:
        ...
        if move_count % 2 == 0:
            with open(file_path + "GT_pose.txt", "a") as fp:
                fp.write("{} {} {} {} {} {} {}\n".format(sensor_state.position[0],sensor_state.position[1],sensor_state.position[2],  
                    sensor_state.rotation.w, sensor_state.rotation.x, sensor_state.rotation.y, sensor_state.rotation.z))
            cv2.imwrite(file_path + 'color/' + '{0:04d}.jpg'.format(pic_count), rgb)
            cv2.imwrite(file_path + 'depth/' + '{0:04d}.png'.format(pic_count), depth)
            pic_count += 1
        move_count += 1
